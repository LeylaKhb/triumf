    ...
    return (
        <div className="page_content">
            ...
            <div style={{ textAlign: 'left', margin: '25px', color: 'black', lineHeight: 1.4 }}>
                ...
                <p>Начало занятий со второй недели сентября, в дальнейшем – в зависимости от выбранного профиля и продолжительности обучения. Объявления о последующем наборе будут выставлены на сайте, в Инстаграм, в группе ВК и в СМИ в качестве рекламы.</p>
            </div>
